            ...
            <div className="container">
                <div className="row">
                    <div className="col-12 col-md8">
                        ...
                        <img src='https://firebasestorage.googleapis.com/v0/b/spotyja-9de98.appspot.com/o/Inmortalizedimg.jpg?alt=media&token=677a6722-d77e-4a1a-b9b0-e7316710f143' className="">

                        </img>
                    </div>
                    <div className="col-12 col-md4 mt-5 conciertos">
                        <div className="row">
                            <div className="col-1">
                                <i className="bi bi-fire iconos"></i>                        
                            </div>                            
                            <div className="col">
                                <div className="row">
                                    <h1>Medellin</h1>
           ...
           <div className="container-fluid mt-5">
            <div className="row">
                ...
                <div className="col-12 col-md-4">
                    ...
                    <img src="https://firebasestorage.googleapis.com/v0/b/spotyja-9de98.appspot.com/o/disturbedNoticia3.jpg?alt=media&token=5c6f3b92-355b-48d5-be6d-875d70e89946" alt="" className="img-fluid w-100"/>
                ...
                <div className="col-12 col-md-4">
                    ...
                    <img src="https://firebasestorage.googleapis.com/v0/b/spotyja-9de98.appspot.com/o/disturbedNoticia2.jpg?alt=media&token=c3ad2685-9673-45c2-ac2c-7a13e10185a7" alt="" className="img-fluid w-100"/>
                ...
                <div className="col-12 col-md-4">
                    ...
                    <img src="https://firebasestorage.googleapis.com/v0/b/spotyja-9de98.appspot.com/o/disturbedNoticia.jpg?alt=media&token=c1d4df7b-f6f9-4906-9af4-54c92e8239e6" alt="" className="img-fluid w-100"/>
